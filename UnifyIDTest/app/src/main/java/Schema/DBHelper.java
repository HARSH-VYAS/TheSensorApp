...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TableSchema.table.TABLE_NAME2 + "(" + TableSchema.table.COLUMN_NAME_ID + " integer primary key Autoincrement, " +
                TableSchema.table.COLUMN_NAME_SENSOR_NAME + " text," + TableSchema.table.COLUMN_NAME_SENSOR_Time + " text, " +
                TableSchema.table.COLUMN_NAME_Sensor_ValueX + " text," + TableSchema.table.COLUMN_NAME_Sensor_ValueY + " text," +
                TableSchema.table.COLUMN_NAME_Sensor_ValueZ + " text," +
                TableSchema.table.COLUMN_NAME_Accuracy + " text)");

        db.execSQL("create table " + TableSchema.table.TABLE_NAME3 + "(" + TableSchema.table.COLUMN_NAME_ID + " integer primary key Autoincrement, " +
                TableSchema.table.COLUMN_NAME_SENSOR_NAME + " text," + TableSchema.table.COLUMN_NAME_SENSOR_Time + " text, " +
                TableSchema.table.COLUMN_NAME_Sensor_ValueX + " text," + TableSchema.table.COLUMN_NAME_Sensor_ValueY + " text," +
                TableSchema.table.COLUMN_NAME_Sensor_ValueZ + " text," +
                TableSchema.table.COLUMN_NAME_Accuracy + " text)");

        db.execSQL("create table " + TableSchema.table.TABLE_NAME4 + "(" + TableSchema.table.COLUMN_NAME_ID + " integer primary key Autoincrement, " +
                TableSchema.table.COLUMN_NAME_SENSOR_NAME + " text," + TableSchema.table.COLUMN_NAME_SENSOR_Time + " text, " +
